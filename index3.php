...
<div class="card" style="background:  #e6f1f7">
			<div class="card-header" style="background:  #e6f1f7">
				<h2>
			...
			<div class="card-body" style="color: black">
				<div class="card bg-light text-center mb-3" style="color: black;">
					<h4 class="m-0 py-3" style="color: black"><strong>Date</strong>: <?php echo $cur_date; ?></h4>
				</div>
